...
export default function BlogCard(props: TBlog) {
  return (
    <article className=" relative rounded-xl overflow-hidden group shadow-md bg-white lg:min-w-[31%] xl:min-w-[23%]  min-w-[98%] sm:min-w-[47%]">
      <Link to={`/blogs/${props._id}`} className=" md:h-64 h-60 block">
        <img
          src={props.image.url}
          loading="lazy"
          alt="music"
      ...
      <div className="md:px-4 md:py-4 p-3">
        ...
        <h3 className="md:my-3 my-1 text-xl text-slate-700 font-medium line-clamp-1">
          {props.title}
        </h3>
        <p
